                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            <li >
                                <a href="#" title="Application Intel" data-filter-tags="application intel">
                                    <i class="fa fa-angle-double-down"></i>
                                    <span class="nav-link-text" data-i18n="nav.application_intel">Kits Inventory</span>
                                </a>
                                <ul>
                                  <li>
                                ...
                                <li>
                                        <a href="<?php echo base_url('')?>Kitsissuance" title="Introduction" data-filter-tags="application intel introduction">
                                            <span class="nav-link-text" data-i18n="nav.application_intel_introduction">Kits Issuance</span>
                                        </a>
                                    </li>
